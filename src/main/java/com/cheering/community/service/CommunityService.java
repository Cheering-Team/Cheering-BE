...
public class CommunityService {
    ...
    public void setData() {
        ...
        TeamCommunity psgCommunity = TeamCommunity.builder().name("파리 생제르맹").players(new ArrayList<>())
                .build();
        TeamCommunity tottenhamCommunity = TeamCommunity.builder().name("토트넘").players(new ArrayList<>())
                .build();
