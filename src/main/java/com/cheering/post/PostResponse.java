...
public class PostResponse {
    ...
    public record PostInfoDTO(Boolean isWriter, String content, LocalDateTime createAt, List<String> tags, List<PostImageResponse.ImageDTO> images, WriterDTO writer) { }
